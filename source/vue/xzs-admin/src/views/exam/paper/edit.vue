  ...
  <div class="app-container">
    ...
    >
      <el-form-item label="年级：" prop="level" required>
        <el-select v-model="form.level" placeholder="Level" @change="levelChange">
          <el-option
      ...
      <el-form-item label="试卷类型：" prop="paperType" required>
        <el-select v-model="form.paperType" placeholder="Paper Type">
          <el-option
      ...
      <el-form-item label="时间限制：" required v-show="form.paperType === 4 || form.paperType === 6">
        <el-date-picker
      ...
      <el-form-item label="建议时长：" prop="suggestTime" required>
        <el-input v-model.number="form.suggestTime" type="number" placeholder="Minutes" />
      </el-form-item>
      <el-form-item>
        <el-button type="primary" @click="submitForm">Submit</el-button>
        <el-button @click="resetForm">Reset</el-button>
        <el-button type="success" @click="addTitle">Add Title</el-button>
      </el-form-item>
    </el-form>
    <el-dialog :visible.sync="questionPage.showDialog" width="70%">
      ...
      >
        ...
        <el-table-column
          ...
          width="70px"
        />
        <el-table-column prop="shortTitle" label="Question Stem" show-overflow-tooltip />
      </el-table>
      <pagination
...
export default {
  ...
  data() {
    return {
      ...
      formLoading: false,
      rules: {
        level: [{ required: true, message: "Please select a grade", trigger: "change" }],
        subjectId: [{ required: true, message: "Please select a subject", trigger: "change" }],
        paperType: [{ required: true, message: "Please select a paper type", trigger: "change" }],
        name: [{ required: true, message: "Please enter a paper name", trigger: "blur" }],
        suggestTime: [{ required: true, message: "Please enter a suggested duration", trigger: "blur" }],
      },
      questionPage: {
        multipleSelection: [],
        showDialog: false,
