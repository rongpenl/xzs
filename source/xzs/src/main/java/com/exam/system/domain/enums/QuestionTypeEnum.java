...
public enum QuestionTypeEnum {
    ...
    SingleChoice(1, "单选题 Single Choice"),
    MultipleChoice(2, "多选题 Multiple Choice"),
    TrueFalse(3, "判断题 True/False"),
    GapFilling(4, "填空题 Gap Filling"),
    ShortAnswer(5, "简答题 Short Answer");
